...
# Chrome Extension (MV3) Boilerplate with React 19 and Webpack 5
...
- Recently updated from **[React](https://reactjs.org)** ~~18~~ to **19**!
...
---
### Q&A
I modify the forked repo, auto-reload not use websocket, but it still works fine in `file change` mode. So we can avoid see connect issue in console. 

Because of this, we cannot update content script in runtime, if you want reload the content script, you can click the extension icon to reload the page manually or use third-party extension to reload the page automatically, like [Extensions Reloader](https://chromewebstore.google.com/detail/extensions-reloader/fimgfedafeadlieiabdeeaodndnlbhid?pli=1), [Advanced Extension Reloader](https://chromewebstore.google.com/detail/advanced-extension-reload/hagknokdofkmojolcpbddjfdjhnjdkae).
